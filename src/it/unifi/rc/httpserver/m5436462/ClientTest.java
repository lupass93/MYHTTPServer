...
public class ClientTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			msg[0] = "PUT /NuovoFileDoc.doc HTTP/1.1\r\nConnection: Keep-Alive\r\n\r\n Aggiungiamo: à ù è ò ì\r\n";
			msg[1] = "GET /NuovoFileDoc.doc HTTP/1.1\r\nConnection: Keep-Alive\r\n\r\n";
			...
			msg[10] = "GET /pagina.txt HTTP/1.1\r\nHost: www.example.org\r\nConnection: Keep-Alive\r\nIf-Modified-Since: Mon, 22 Jan 2018 14:08:54 GMT\r\n\r\n";
			msg[11] = "POST /pagina.txt HTTP/1.1\r\nHost: www.example.org\r\nConnection: Keep-Alive\r\n\r\nAggiungiamo al file una riga\r\n";
			msg[12] = "HEAD /pagina.txt HTTP/1.1\r\nHost: www.example.org\r\nConnection: Keep-Alive\r\nIf-Modified-Since: Mon, 22 Jan 2018 14:08:54 GMT\r\n";
			msg[13] = "GET /pagina.txt HTTP/1.1\r\nHost: www.example.org\r\nConnection: Keep-Alive\r\nIf-Modified-Since: Mon, 22 Jan 2018 14:08:54 GMT\r\n\r\n";
			msg[14] = "PUT /pagina2.html HTTP/1.1\r\nHost: www.example.org\r\nConnection: Keep-Alive\r\n\r\nProva metodo PUT\r\n";
			msg[15] = "DELETE /pagina2.html HTTP/1.1\r\nHost: www.example.org\r\nConnection: Keep-Alive\r\n\r\n";
			msg[16] = "GET /paginaInesistente HTTP/1.1\r\nHost: www.example.org\r\nConnection: Keep-Alive\r\nIf-Modified-Since: Mon, 22 Jan 2018 14:08:54 GMT\r\n\r\n";
			msg[17] = "HEAD /paginaInesistente HTTP/1.1\r\nHost: www.example.org\r\nConnection: Keep-Alive\r\nIf-Modified-Since: Mon, 22 Jan 2018 14:08:54 GMT\r\n\r\n";
			msg[18] = "POST /paginaInesistente HTTP/1.1\r\nHost: www.example.org\r\nConnection: Keep-Alive\r\n\r\n AGGIUNGI UNA RIGA AL FILE\r\n";
			msg[19] = "DELETE /paginaInesistente HTTP/1.1\r\nHost: www.example.org\r\nConnection: Keep-Alive\r\n\r\n";
			// MESSAGGI DI TEST PER HTTP/1.0
			msg[20] = "GET /pagina.txt HTTP/1.0\r\nConnection: Keep-Alive\r\nIf-Modified-Since: Mon, 22 Jan 2018 14:08:54 GMT\r\n\r\n";
			msg[21] = "POST /pagina.txt HTTP/1.0\r\nConnection: Keep-Alive\r\n\r\nAggiungiamo al file una riga\r\n";
			msg[22] = "HEAD /pagina.txt HTTP/1.0\r\nConnection: Keep-Alive\r\nIf-Modified-Since: Mon, 22 Jan 2018 14:08:54 GMT\r\n";
			msg[23] = "GET /pagina.txt HTTP/1.0\r\nConnection: Keep-Alive\r\nIf-Modified-Since: Mon, 22 Jan 2018 14:08:54 GMT\r\n\r\n";
			msg[24] = "GET /pagina.txt HTTP/1.0\r\nConnection: Keep-Alive\r\n\r\n";
			msg[25] = "GET /pagina.txt HTTP/1.0\r\nConnection: Keep-Alive\r\n\r\n";
			
			// MESSAGGI DI TEST PER HTTP/1.0 con Host
			msg[26] = "GET /pagina.txt HTTP/1.0\r\nHost: www.esempio.it\r\nConnection: Keep-Alive\r\nIf-Modified-Since: Mon, 22 Jan 2018 14:08:54 GMT\r\n\r\n";
			msg[27] = "POST /pagina.txt HTTP/1.0\r\nHost: www.esempio.it\r\nConnection: Keep-Alive\r\n\r\nAggiungiamo al file una riga\r\n";
			msg[28] = "HEAD /pagina.txt HTTP/1.0\r\nHost: www.esempio.it\r\nConnection: Keep-Alive\r\nIf-Modified-Since: Mon, 22 Jan 2018 14:08:54 GMT\r\n";
			msg[29] = "GET /pagina.txt HTTP/1.0\r\nHost: www.esempio.it\r\nConnection: Keep-Alive\r\nIf-Modified-Since: Mon, 22 Jan 2018 14:08:54 GMT\r\n\r\n";
			msg[30] = "GET /pagina.txt HTTP/1.0\r\nHost: www.esempio.it\r\nConnection: Keep-Alive\r\n\r\n";
			msg[31] = "GET /pagina.txt HTTP/1.0\r\nHost: www.esempio.it\r\nConnection: close\r\n\r\n";
